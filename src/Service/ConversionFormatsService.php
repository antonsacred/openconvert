...
final class ConversionFormatsService
{
    ...
    {
        $conversionsUrl = $this->resolveConversionsUrl();
    ...
    private function resolveConversionsUrl(): ?string
    {
        $candidates = [
        ...
        foreach ($candidates as $candidate) {
            ...
            if ($trimmed !== '') {
                return rtrim($trimmed, '/').'/v1/conversions';
            }
        }
